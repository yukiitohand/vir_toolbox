function [hdr_info] = extract_qqhdr_from_lbl_vir(lbl_info)
% [hdr_info] = extract_qqhdr_from_lbl_vir(lbl_info)
%   extract header information of qq file (envi format) from VIR LABEL file
%  Input Parameters
