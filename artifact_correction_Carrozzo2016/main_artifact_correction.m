...
save vesta_Survey_median_spectrum.mat sctime_info_vesta_mp idxes_valid isinc_lt_50_list img_spcs_meds
...
A = (im_med_t_smthd_outrmvd_bdx_out-P_Umed)./P_Umed;
...
I1Bim_ifc_smthd_cor = I1Bim_ifc_smthd(bdx_out,:) ./ (1+A(:,c));
