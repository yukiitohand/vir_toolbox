function [dirs,files] = vir_downloader(subdir_local,varargin)
% [dirs,files] = vir_downloader(subdir_local,varargin)
% read files from VIR. This is an internal function. Please be careful
% using this directly.
%
% Inputs:
%  subdir_local:
...
global vir_env_vars
localrootDir = vir_env_vars.local_VIRrootDir;
url_local_root = vir_env_vars.url_local_root;
url_remote_root = vir_env_vars.url_remote_root;
        ...
        elseif strcmpi(lnks(i).type,'DIR')
            ...
            if dirskip
               % skip
                ...
                [dirs_ch,files_ch] = vir_downloader(...
